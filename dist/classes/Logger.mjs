...
// License: MIT
//------------------------------------------------------------------------------
import{DateHandler as e}from"./DateHandler.mjs";let t=`info`;const n={silly:0,debug:1,success:1,info:2,warning:3,error:4},r={debug:`\x1B[1;36m`,info:`\x1B[1;37m`,silly:`\x1B[1;35m`,success:`\x1B[1;32m`,warning:`\x1B[1;33m`,error:`\x1B[1;31m`,reset:`\x1B[0;22;23;24;25;27;28;29m`,simple_reset:`\x1B[0;22m`,dim_white:`\x1B[2m`},i=new Set;function a(e,t){i.has(e)||(process.stdout.write(`${r.warning}Deprecation Warning:${r.reset} ${r.dim_white}The ${e}() function is deprecated and will be removed in a future version, please use ${t}() instead.${r.reset}\n`),i.add(e))}var o=class i{static log(i=`silly`,a){if(process.env.NODE_ENV?.toLowerCase().startsWith(`dev`)||(t=`warning`),n[i]<n[t])return;let o=`${r[i]}[${i.toUpperCase()}]${r.simple_reset}`,s=`${r.dim_white}${n[t]<=1?e.formatted_with_milliseconds:e.formatted}`+r.reset;process.stdout.write(`${s} ${o.padEnd(23)} ${a}\n`)}static clear(){process.stdout.write(`\x1B[H\x1B[2J\x1B[3J`),process.stdout.write(`${r.dim_white}Console cleared${r.reset}\n`)}static fatal(e,t){t?(i.log(`error`,`[Fatal]: ${e} \n ${t}\n`),process.stderr.write(`[Fatal]: ${e} \n${t}\n`)):(i.log(`error`,`[Fatal]: ${e}\n`),process.stderr.write(`[Fatal]: ${e} \n`)),process.exit(1)}};function s(e=`silly`,t){a(`log`,`Logger.log()`),o.log(e,t)}function c(){o.clear(),a(`clear`,`Logger.clear`)}function l(e,t){a(`fatal`,`Logger.fatal`),o.fatal(e,t)}export{c as clear,r as colors,o as default,l as fatal,n as levelPriority,s as log,s as logger,t as logLevel};
